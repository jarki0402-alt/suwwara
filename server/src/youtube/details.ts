...
/**
 * Fetches full video details, preferring YouTube's own "Music in this video"
 * Content-ID metadata (title/artist/album/cover) when present — this is
 * officially licensed metadata attached by YouTube itself, more reliable
 * than parsing the human-written video title.
 */
